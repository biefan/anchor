...
> Engineering discipline for Claude Code & Codex CLI: a skill + 16 slash commands + 4 safety hooks that keep AI on-task, prevent drift, and don't stop until the job is done.
