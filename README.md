...
> Claude Code / Codex CLI 的工程化纪律：skill + 22 个 slash commands + 5 个 hooks + 统一长期记忆系统（pitfalls / decisions / preferences / snapshots 跨 session 跨项目），让 AI 写代码"少走错路、不偏题、跑到完为止"。
